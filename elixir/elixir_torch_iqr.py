...
Q1 = output_data.quantile(0.25)
Q3 = output_data.quantile(0.75)
IQR = Q3 - Q1
...
non_outliers = ((output_data >= lower_bound) & (output_data <= upper_bound)).all(axis=1)
...
#comparison_df.to_csv('predictions_iqr.csv', index=False)
