...
def train_gpu(model, dataloader, criterion, optimizer, epochs=500):
...
# Train the model
train_gpu(model, dataloader, criterion, optimizer, epochs=500)

# Save model
torch.save(model, 'elixir_torch.pt')
